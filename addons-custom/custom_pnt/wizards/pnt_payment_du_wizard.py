...
class PntPaymentDu(models.TransientModel):
    ...
    pnt_payment_type = fields.Selection(
        ...
        string="Single Document payment type",
    )
    ...
    #             raise UserError(
    #                 _('El DNI que se tiene en la base de datos tiene la fecha de Validez vencida o la fecha de validez está en blanco'))
    ...
    #         self.pnt_single_document_id.pnt_partner_pickup_id = self.pnt_partner_pickup_id
